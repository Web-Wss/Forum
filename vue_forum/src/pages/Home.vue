<template>
  <div class="home">
    <van-nav-bar @click-left="onClickLeft" title="推荐" fixed>
      <template #left>
...
export default {
  ...
  methods: {
    ...
    goPostsDetail(t) {
      console.log(111);
      console.log(t.postsLikeUserList[0]);
      this.$router.push({
        name: "postsdetail",
        query: {
          posts_id: t.posts_id,
          ...
          postsLikeUserList: t.postsLikeUserList[0],
        },
      });
    },
...
<style scoped>
.van-nav-bar__left .van-icon-search {
  color: black;
}
